...
const MobNav = () => {
  return (
    <div className="md:hidden fixed bottom-0 w-full h-14   justify-between px-8 py-1 items-center bg-linear-to-t from-border/70 to-primary-foreground/70 to-70% rounded-t-4xl  flex">
